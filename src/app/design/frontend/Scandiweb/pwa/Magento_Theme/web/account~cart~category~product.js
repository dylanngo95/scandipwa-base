(this["webpackJsonp"] = this["webpackJsonp"] || []).push([["account~cart~category~product"],{
...
/* harmony import */ var _ExpandableContent_style__WEBPACK_IMPORTED_MODULE_4__ = __webpack_require__(/*! ./ExpandableContent.style */ "../../../../../vendor/scandipwa/source/src/app/component/ExpandableContent/ExpandableContent.style.scss");
/* harmony import */ var _ExpandableContent_style__WEBPACK_IMPORTED_MODULE_4___default = /*#__PURE__*/__webpack_require__.n(_ExpandableContent_style__WEBPACK_IMPORTED_MODULE_4__);
...
function (_Extensible) {
  ...
  function _ExpandableContent() {
    ...
    _defineProperty(_assertThisInitialized(_this), "toggleExpand", function () {
      ...
      _this.setState(function (_ref) {
        ...
        return _this.scrollToExpandedContent(['NavigationTabs', 'ProductActionsWrapper', 'CartPageSummary']);
      });
    });
  ...
  _createClass(_ExpandableContent, [{
    ...
    value: function scrollToExpandedContent(coveringElementsIds) {
      ...
      var coveringElementsHeight = coveringElementsIds.reduce(function (acc, elementId) {
        var coveringElement = document.getElementById(elementId);
      ...
      var scrollTo = topToElemDistance - (screen.height - coveringElementsHeight - elem.offsetHeight); // checking if button is in a view-port
...
//# sourceMappingURL=account~cart~category~product.js.map