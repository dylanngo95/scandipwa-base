...
function (_Extensible) {
  ...
  _createClass(_CartOverlay, [{
    ...
    value: function renderPriceLine(price) {
      ...
      return "".concat(parseFloat(price).toFixed(2)).concat(Object(_app_design_frontend_Scandiweb_pwa_src_app_util_Price__WEBPACK_IMPORTED_MODULE_10__["formatCurrency"])(currencyCode));
    }
  }, {
    key: "renderCartItems",
    ...
    value: function renderDiscount() {
      var _this$props$totals2 = this.props.totals,
          ...
          _this$props$totals2$d = _this$props$totals2.discount_amount,
          discount_amount = _this$props$totals2$d === void 0 ? 0 : _this$props$totals2$d;
      ...
      return (
        ...
        /*#__PURE__*/
        _checkBEM(React, "dt", null, __('Coupon '),
        /*#__PURE__*/
...
function (_Extensible) {
  ...
  _createClass(_CartPage, [{
    ...
    value: function renderPriceLine(price) {
      ...
      return "".concat(Object(_app_design_frontend_Scandiweb_pwa_src_app_util_Price__WEBPACK_IMPORTED_MODULE_11__["formatCurrency"])(quote_currency_code)).concat(Object(_app_design_frontend_Scandiweb_pwa_src_app_util_Price__WEBPACK_IMPORTED_MODULE_11__["roundPrice"])(price));
    }
  }, {
    ...
    value: function renderDiscount() {
      var _this$props$totals3 = this.props.totals,
          coupon_code = _this$props$totals3.coupon_code,
          _this$props$totals3$d = _this$props$totals3.discount_amount,
          discount_amount = _this$props$totals3$d === void 0 ? 0 : _this$props$totals3$d;
