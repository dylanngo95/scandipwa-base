  ...
  _createClass(_CartItem, [{
    ...
    value: function renderContent() {
      ...
      return (
        ...
        }, this.renderProductName(), this.renderOutOfStockMessage(), this.renderProductOptions(customizable_options), this.renderProductOptions(bundle_options), this.renderProductConfigurations(), this.renderProductPrice())
      );
    }
  }, {
...
/* harmony import */ var _app_design_frontend_Scandiweb_pwa_src_app_component_ProductActions_ProductActions_config__WEBPACK_IMPORTED_MODULE_3__ = __webpack_require__(/*! ../../../../../../../app/design/frontend/Scandiweb/pwa/src/app/component/ProductActions/ProductActions.config */ "./src/app/component/ProductActions/ProductActions.config.js");
    ...
    value: function render() {
      ...
      return (
        ...
        _checkBEM(React, "data", {
          value: price
        }, "".concat(Object(_app_design_frontend_Scandiweb_pwa_src_app_util_Price__WEBPACK_IMPORTED_MODULE_3__["formatCurrency"])(currency_code)).concat(price))))
      );
    }
  }]);
