...
/* harmony import */ var _ProductAttributeValue_style__WEBPACK_IMPORTED_MODULE_5__ = __webpack_require__(/*! ./ProductAttributeValue.style */ "../../../../../vendor/scandipwa/source/src/app/component/ProductAttributeValue/ProductAttributeValue.style.scss");
/* harmony import */ var _ProductAttributeValue_style__WEBPACK_IMPORTED_MODULE_5___default = /*#__PURE__*/__webpack_require__.n(_ProductAttributeValue_style__WEBPACK_IMPORTED_MODULE_5__);
  ...
  _createClass(_ProductPrice, [{
    ...
    value: function getCurrentPriceSchema() {
      var _this$props = this.props,
          ...
          variantsCount = _this$props.variantsCount;
    ...
    value: function renderCurrentPrice() {
      var _this$props2 = this.props,
          discountPercentage = _this$props2.discountPercentage,
          formatedCurrency = _this$props2.formatedCurrency,
          currency = _this$props2.currency;
      var schema = this.getCurrentPriceSchema(); // Use <ins></ins> <del></del> to represent new price and the old (deleted) one
      ...
      return (
        ...
        /*#__PURE__*/
        _checkBEM(React, "span", null, currency),
        /*#__PURE__*/
        _checkBEM(React, "span", schema, formatedCurrency)))
      );
    }
  }, {
    key: "renderOldPrice",
    value: function renderOldPrice() {
      var _this$props3 = this.props,
          roundedRegularPrice = _this$props3.roundedRegularPrice,
          discountPercentage = _this$props3.discountPercentage,
          isSchemaRequired = _this$props3.isSchemaRequired,
          variantsCount = _this$props3.variantsCount;
    ...
    value: function renderSchema() {
      var _this$props4 = this.props,
          ...
          priceCurrency = _this$props4.priceCurrency;
    ...
    value: function render() {
      ...
      var final_price = _this$props5$price$mi.final_price,
          ...
          formatedCurrency = _this$props5.formatedCurrency,
      ...
      return (
        ...
        _checkBEM(React, "p", {
          block: "ProductPrice",
          mix: mix,
          "aria-label": "Product price: ".concat(formatedCurrency).concat(currency)
...
_defineProperty(ProductPrice, "propTypes", {
  ...
  formatedCurrency: prop_types__WEBPACK_IMPORTED_MODULE_0___default.a.string,
...
function (_Extensible) {
  ...
  function _ProductPriceContainer() {
    ...
    _defineProperty(_assertThisInitialized(_this), "containerProps", function () {
      ...
      var formatedCurrency = Object(_app_design_frontend_Scandiweb_pwa_src_app_util_Price__WEBPACK_IMPORTED_MODULE_4__["roundPrice"])(finalPrice);
      var currency = Object(_app_design_frontend_Scandiweb_pwa_src_app_util_Price__WEBPACK_IMPORTED_MODULE_4__["formatCurrency"])(priceCurrency);
      return {
...
function (_Extensible) {
  ...
  function _TierPrices() {
    ...
    _defineProperty(_assertThisInitialized(_this), "renderDetailedTierPrice", function (_ref) {
      ...
      var formattedCurrency = Object(_app_design_frontend_Scandiweb_pwa_src_app_util_Price__WEBPACK_IMPORTED_MODULE_3__["formatCurrency"])(currency);
      var roundedPrice = Object(_app_design_frontend_Scandiweb_pwa_src_app_util_Price__WEBPACK_IMPORTED_MODULE_3__["roundPrice"])(value);
      return (
        /*#__PURE__*/
        _checkBEM(React, "li", {
          block: "TierPrices",
          elem: "Item",
          key: quantity
        }, __('Buy %s for %s%s each and ', quantity, formattedCurrency, roundedPrice),
        /*#__PURE__*/
    ...
    value: function renderLowestTierPrice() {
      ...
      return (
        ...
        _checkBEM(React, "span", {
          block: "TierPrices",
          elem: "ItemPrice"
        }, "".concat(Object(_app_design_frontend_Scandiweb_pwa_src_app_util_Price__WEBPACK_IMPORTED_MODULE_3__["formatCurrency"])(currency)).concat(Object(_app_design_frontend_Scandiweb_pwa_src_app_util_Price__WEBPACK_IMPORTED_MODULE_3__["roundPrice"])(lowestValue))))
      );
    }
  }, {
...
/* harmony import */ var _SharedTransition_SharedTransition_unstated__WEBPACK_IMPORTED_MODULE_3__ = __webpack_require__(/*! ../SharedTransition/SharedTransition.unstated */ "../../../../../vendor/scandipwa/source/src/app/component/SharedTransition/SharedTransition.unstated.js");
/* harmony import */ var _type_ProductList__WEBPACK_IMPORTED_MODULE_4__ = __webpack_require__(/*! ../../type/ProductList */ "../../../../../vendor/scandipwa/source/src/app/type/ProductList.js");
/* harmony import */ var _util_Product__WEBPACK_IMPORTED_MODULE_5__ = __webpack_require__(/*! ../../util/Product */ "../../../../../vendor/scandipwa/source/src/app/util/Product/index.js");
/* harmony import */ var _util_Url__WEBPACK_IMPORTED_MODULE_6__ = __webpack_require__(/*! ../../util/Url */ "../../../../../vendor/scandipwa/source/src/app/util/Url/index.js");
...
var CartDispatcher = __webpack_require__.e(/*! import() | dispatchers */ "dispatchers").then(__webpack_require__.bind(null, /*! ../../store/Cart/Cart.dispatcher */ "../../../../../vendor/scandipwa/source/src/app/store/Cart/Cart.dispatcher.js"));
