...
function (_Extensible) {
  ...
  _createClass(_CheckoutDeliveryOption, [{
    ...
    value: function renderPrice() {
      ...
      var roundedUpPrice = Object(_app_design_frontend_Scandiweb_pwa_src_app_util_Price__WEBPACK_IMPORTED_MODULE_4__["roundPrice"])(price_incl_tax);
      return (
        /*#__PURE__*/
        _checkBEM(React, "strong", null, " - ".concat(roundedUpPrice).concat(Object(_app_design_frontend_Scandiweb_pwa_src_app_util_Price__WEBPACK_IMPORTED_MODULE_4__["formatCurrency"])(quote_currency_code)))
      );
    }
  }, {
    key: "renderRow",
...
"use strict";
__webpack_require__.r(__webpack_exports__);
/* WEBPACK VAR INJECTION */(function(Extensible, React, __, middleware) {/* harmony export (binding) */ __webpack_require__.d(__webpack_exports__, "_CheckoutGuestForm", function() { return _CheckoutGuestForm; });
...
/* harmony import */ var _CheckoutGuestForm_style__WEBPACK_IMPORTED_MODULE_4__ = __webpack_require__(/*! ./CheckoutGuestForm.style */ "../../../../../vendor/scandipwa/source/src/app/component/CheckoutGuestForm/CheckoutGuestForm.style.scss");
/* harmony import */ var _CheckoutGuestForm_style__WEBPACK_IMPORTED_MODULE_4___default = /*#__PURE__*/__webpack_require__.n(_CheckoutGuestForm_style__WEBPACK_IMPORTED_MODULE_4__);
function _typeof(obj) { if (typeof Symbol === "function" && typeof Symbol.iterator === "symbol") { _typeof = function _typeof(obj) { return typeof obj; }; } else { _typeof = function _typeof(obj) { return obj && typeof Symbol === "function" && obj.constructor === Symbol && obj !== Symbol.prototype ? "symbol" : typeof obj; }; } return _typeof(obj); }
...
function (_Extensible) {
  ...
  function _CheckoutGuestForm() {
    ...
    return _possibleConstructorReturn(this, _getPrototypeOf(_CheckoutGuestForm).apply(this, arguments));
  }
  ...
  _createClass(_CheckoutGuestForm, [{
    ...
    value: function renderCreateUserCheckbox() {
      var _this$props = this.props,
          isCreateUser = _this$props.isCreateUser,
          handleCreateUser = _this$props.handleCreateUser,
          isEmailConfirmationRequired = _this$props.isEmailConfirmationRequired; // if email confirmation required and user is not logged in
    ...
    get: function get() {
      var _this$props2 = this.props,
          handleEmailInput = _this$props2.handleEmailInput,
          handlePasswordInput = _this$props2.handlePasswordInput,
...
/*!******************************************************************************************************************!*\
  ...
  \******************************************************************************************************************/
/*! exports provided: mapStateToProps, mapDispatchToProps, _CheckoutGuestFormContainer, CheckoutGuestFormContainer, default */
/***/ (function(module, __webpack_exports__, __webpack_require__) {
...
/* harmony import */ var _CheckoutGuestForm_component__WEBPACK_IMPORTED_MODULE_5__ = __webpack_require__(/*! ./CheckoutGuestForm.component */ "../../../../../vendor/scandipwa/source/src/app/component/CheckoutGuestForm/CheckoutGuestForm.component.js");
function _typeof(obj) { if (typeof Symbol === "function" && typeof Symbol.iterator === "symbol") { _typeof = function _typeof(obj) { return typeof obj; }; } else { _typeof = function _typeof(obj) { return obj && typeof Symbol === "function" && obj.constructor === Symbol && obj !== Symbol.prototype ? "symbol" : typeof obj; }; } return _typeof(obj); }
...
var mapDispatchToProps = middleware(function (dispatch) {
  return {
    showErrorNotification: function showErrorNotification(error) {
      return dispatch(Object(_app_design_frontend_Scandiweb_pwa_src_app_store_Notification_Notification_action__WEBPACK_IMPORTED_MODULE_4__["showNotification"])('error', error[0].message));
    }
  };
...
function (_Extensible) {
  ...
  function _CheckoutGuestFormContainer() {
    ...
    _defineProperty(_assertThisInitialized(_this), "containerProps", function () {
      ...
      return {
        formId: _app_design_frontend_Scandiweb_pwa_src_app_route_Checkout_Checkout_config__WEBPACK_IMPORTED_MODULE_3__["SHIPPING_STEP"],
  ...
  _createClass(_CheckoutGuestFormContainer, [{
    ...
    value: function render() {
      ...
      return (
        /*#__PURE__*/
        _checkBEM(React, _CheckoutGuestForm_component__WEBPACK_IMPORTED_MODULE_5__["default"], _extends({}, this.props, this.containerFunctions, this.containerProps()))
      );
    }
  }]);
...
function (_Extensible) {
  ...
  _createClass(_CheckoutOrderSummary, [{
    ...
    value: function renderPriceLine(price, name, mods) {
      ...
      var priceString = Object(_app_design_frontend_Scandiweb_pwa_src_app_util_Price__WEBPACK_IMPORTED_MODULE_5__["formatCurrency"])(quote_currency_code);
      return (
        /*#__PURE__*/
        _checkBEM(React, "li", {
        ...
        _checkBEM(React, "strong", {
          block: "CheckoutOrderSummary",
          elem: "Text"
        }, "".concat(priceString).concat(Object(_app_design_frontend_Scandiweb_pwa_src_app_util_Price__WEBPACK_IMPORTED_MODULE_5__["roundPrice"])(price))))
      );
    }
  }, {
    key: "renderCouponCode",
    value: function renderCouponCode() {
    ...
    value: function renderTotals() {
      var _this$props = this.props,
          ...
          payment_grand_total = _this$props.paymentTotals.grand_total,
...
_defineProperty(CheckoutOrderSummary, "propTypes", {
  ...
  paymentTotals: _app_design_frontend_Scandiweb_pwa_src_app_type_MiniCart__WEBPACK_IMPORTED_MODULE_4__["TotalsType"],
...
/* harmony import */ var react__WEBPACK_IMPORTED_MODULE_1__ = __webpack_require__(/*! react */ "./node_modules/react/index.js");
/* harmony import */ var react__WEBPACK_IMPORTED_MODULE_1___default = /*#__PURE__*/__webpack_require__.n(react__WEBPACK_IMPORTED_MODULE_1__);
/* harmony import */ var _app_design_frontend_Scandiweb_pwa_src_app_component_CheckoutBilling__WEBPACK_IMPORTED_MODULE_2__ = __webpack_require__(/*! ../../../../../../../app/design/frontend/Scandiweb/pwa/src/app/component/CheckoutBilling */ "../../../../../vendor/scandipwa/source/src/app/component/CheckoutBilling/index.js");
/* harmony import */ var _app_design_frontend_Scandiweb_pwa_src_app_component_CheckoutOrderSummary__WEBPACK_IMPORTED_MODULE_3__ = __webpack_require__(/*! ../../../../../../../app/design/frontend/Scandiweb/pwa/src/app/component/CheckoutOrderSummary */ "../../../../../vendor/scandipwa/source/src/app/component/CheckoutOrderSummary/index.js");
/* harmony import */ var _app_design_frontend_Scandiweb_pwa_src_app_component_CheckoutShipping__WEBPACK_IMPORTED_MODULE_4__ = __webpack_require__(/*! ../../../../../../../app/design/frontend/Scandiweb/pwa/src/app/component/CheckoutShipping */ "../../../../../vendor/scandipwa/source/src/app/component/CheckoutShipping/index.js");
/* harmony import */ var _app_design_frontend_Scandiweb_pwa_src_app_component_CheckoutSuccess__WEBPACK_IMPORTED_MODULE_5__ = __webpack_require__(/*! ../../../../../../../app/design/frontend/Scandiweb/pwa/src/app/component/CheckoutSuccess */ "../../../../../vendor/scandipwa/source/src/app/component/CheckoutSuccess/index.js");
/* harmony import */ var _app_design_frontend_Scandiweb_pwa_src_app_component_CmsBlock__WEBPACK_IMPORTED_MODULE_6__ = __webpack_require__(/*! ../../../../../../../app/design/frontend/Scandiweb/pwa/src/app/component/CmsBlock */ "../../../../../vendor/scandipwa/source/src/app/component/CmsBlock/index.js");
...
/* harmony import */ var _app_design_frontend_Scandiweb_pwa_src_app_component_Header_Header_config__WEBPACK_IMPORTED_MODULE_8__ = __webpack_require__(/*! ../../../../../../../app/design/frontend/Scandiweb/pwa/src/app/component/Header/Header.config */ "../../../../../vendor/scandipwa/source/src/app/component/Header/Header.config.js");
...
/* harmony import */ var _app_design_frontend_Scandiweb_pwa_src_app_type_Checkout__WEBPACK_IMPORTED_MODULE_11__ = __webpack_require__(/*! ../../../../../../../app/design/frontend/Scandiweb/pwa/src/app/type/Checkout */ "../../../../../vendor/scandipwa/source/src/app/type/Checkout.js");
...
/* harmony import */ var _Checkout_config__WEBPACK_IMPORTED_MODULE_15__ = __webpack_require__(/*! ./Checkout.config */ "../../../../../vendor/scandipwa/source/src/app/route/Checkout/Checkout.config.js");
/* harmony import */ var _Checkout_style__WEBPACK_IMPORTED_MODULE_16__ = __webpack_require__(/*! ./Checkout.style */ "../../../../../vendor/scandipwa/source/src/app/route/Checkout/Checkout.style.scss");
/* harmony import */ var _Checkout_style__WEBPACK_IMPORTED_MODULE_16___default = /*#__PURE__*/__webpack_require__.n(_Checkout_style__WEBPACK_IMPORTED_MODULE_16__);
function _typeof(obj) { if (typeof Symbol === "function" && typeof Symbol.iterator === "symbol") { _typeof = function _typeof(obj) { return typeof obj; }; } else { _typeof = function _typeof(obj) { return obj && typeof Symbol === "function" && obj.constructor === Symbol && obj !== Symbol.prototype ? "symbol" : typeof obj; }; } return _typeof(obj); }
...
function (_Extensible) {
  ...
  function _Checkout() {
    ...
    _defineProperty(_assertThisInitialized(_this), "stepMap", (_defineProperty2 = {}, _defineProperty(_defineProperty2, _Checkout_config__WEBPACK_IMPORTED_MODULE_15__["SHIPPING_STEP"], {
      title: __('Shipping step'),
      url: '/shipping',
      render: _this.renderShippingStep.bind(_assertThisInitialized(_this)),
      areTotalsVisible: true
    }), _defineProperty(_defineProperty2, _Checkout_config__WEBPACK_IMPORTED_MODULE_15__["BILLING_STEP"], {
      title: __('Billing step'),
      url: '/billing',
      render: _this.renderBillingStep.bind(_assertThisInitialized(_this)),
      areTotalsVisible: true
    }), _defineProperty(_defineProperty2, _Checkout_config__WEBPACK_IMPORTED_MODULE_15__["DETAILS_STEP"], {
  ...
  _createClass(_Checkout, [{
    ...
    value: function componentDidMount() {
      ...
      this.updateHeader();
      history.replace(Object(_app_design_frontend_Scandiweb_pwa_src_app_util_Url__WEBPACK_IMPORTED_MODULE_14__["appendWithStoreCode"])("".concat(_Checkout_config__WEBPACK_IMPORTED_MODULE_15__["CHECKOUT_URL"]).concat(url)));
    }
  }, {
    key: "componentDidUpdate",
    value: function componentDidUpdate(prevProps) {
    ...
    value: function updateHeader() {
      ...
      setHeaderState({
        name: _app_design_frontend_Scandiweb_pwa_src_app_component_Header_Header_config__WEBPACK_IMPORTED_MODULE_8__["CHECKOUT"],
        title: title,
    ...
    value: function updateStep() {
      ...
      var url = this.stepMap[checkoutStep].url;
      history.push(Object(_app_design_frontend_Scandiweb_pwa_src_app_util_Url__WEBPACK_IMPORTED_MODULE_14__["appendWithStoreCode"])("".concat(_Checkout_config__WEBPACK_IMPORTED_MODULE_15__["CHECKOUT_URL"]).concat(url)));
    }
  }, {
    key: "renderTitle",
    ...
    value: function renderShippingStep() {
      ...
      return (
        /*#__PURE__*/
        _checkBEM(React, _app_design_frontend_Scandiweb_pwa_src_app_component_CheckoutShipping__WEBPACK_IMPORTED_MODULE_4__["default"], {
    ...
    value: function renderBillingStep() {
      ...
      return (
        /*#__PURE__*/
        _checkBEM(React, _app_design_frontend_Scandiweb_pwa_src_app_component_CheckoutBilling__WEBPACK_IMPORTED_MODULE_2__["default"], {
          setLoading: setLoading,
          paymentMethods: paymentMethods,
          setDetailsStep: setDetailsStep,
    ...
    value: function renderDetailsStep() {
      ...
      return (
        /*#__PURE__*/
        _checkBEM(React, _app_design_frontend_Scandiweb_pwa_src_app_component_CheckoutSuccess__WEBPACK_IMPORTED_MODULE_5__["default"], {
          orderID: orderID
        })
      );
    }
    ...
    value: function renderSummary() {
      ...
      return (
        /*#__PURE__*/
        _checkBEM(React, _app_design_frontend_Scandiweb_pwa_src_app_component_CheckoutOrderSummary__WEBPACK_IMPORTED_MODULE_3__["default"], {
    ...
    value: function renderPromo() {
      var checkoutStep = this.props.checkoutStep;
      var isBilling = checkoutStep === _Checkout_config__WEBPACK_IMPORTED_MODULE_15__["BILLING_STEP"];
      ...
      return (
        /*#__PURE__*/
        _checkBEM(React, _app_design_frontend_Scandiweb_pwa_src_app_component_CmsBlock__WEBPACK_IMPORTED_MODULE_6__["default"], {
          identifier: promo
        })
      );
    }
    ...
    value: function render() {
      return (
        ...
        /*#__PURE__*/
        _checkBEM(React, "div", null, this.renderSummary(), this.renderPromo())))
      );
    }
  }]);
...
_defineProperty(Checkout, "propTypes", {
  setLoading: prop_types__WEBPACK_IMPORTED_MODULE_0___default.a.func.isRequired,
  setDetailsStep: prop_types__WEBPACK_IMPORTED_MODULE_0___default.a.func.isRequired,
  shippingMethods: _app_design_frontend_Scandiweb_pwa_src_app_type_Checkout__WEBPACK_IMPORTED_MODULE_11__["shippingMethodsType"].isRequired,
  onShippingEstimationFieldsChange: prop_types__WEBPACK_IMPORTED_MODULE_0___default.a.func.isRequired,
  setHeaderState: prop_types__WEBPACK_IMPORTED_MODULE_0___default.a.func.isRequired,
  paymentMethods: _app_design_frontend_Scandiweb_pwa_src_app_type_Checkout__WEBPACK_IMPORTED_MODULE_11__["paymentMethodsType"].isRequired,
  saveAddressInformation: prop_types__WEBPACK_IMPORTED_MODULE_0___default.a.func.isRequired,
  savePaymentInformation: prop_types__WEBPACK_IMPORTED_MODULE_0___default.a.func.isRequired,
  isLoading: prop_types__WEBPACK_IMPORTED_MODULE_0___default.a.bool.isRequired,
  isDeliveryOptionsLoading: prop_types__WEBPACK_IMPORTED_MODULE_0___default.a.bool.isRequired,
  shippingAddress: _app_design_frontend_Scandiweb_pwa_src_app_type_Account__WEBPACK_IMPORTED_MODULE_10__["addressType"].isRequired,
  checkoutTotals: _app_design_frontend_Scandiweb_pwa_src_app_type_MiniCart__WEBPACK_IMPORTED_MODULE_13__["TotalsType"].isRequired,
  orderID: prop_types__WEBPACK_IMPORTED_MODULE_0___default.a.string.isRequired,
  history: _app_design_frontend_Scandiweb_pwa_src_app_type_Common__WEBPACK_IMPORTED_MODULE_12__["HistoryType"].isRequired,
  onEmailChange: prop_types__WEBPACK_IMPORTED_MODULE_0___default.a.func.isRequired,
  paymentTotals: _app_design_frontend_Scandiweb_pwa_src_app_type_MiniCart__WEBPACK_IMPORTED_MODULE_13__["TotalsType"],
  checkoutStep: prop_types__WEBPACK_IMPORTED_MODULE_0___default.a.oneOf([_Checkout_config__WEBPACK_IMPORTED_MODULE_15__["SHIPPING_STEP"], _Checkout_config__WEBPACK_IMPORTED_MODULE_15__["BILLING_STEP"], _Checkout_config__WEBPACK_IMPORTED_MODULE_15__["DETAILS_STEP"]]).isRequired,
  isCreateUser: prop_types__WEBPACK_IMPORTED_MODULE_0___default.a.bool.isRequired,
  onCreateUserChange: prop_types__WEBPACK_IMPORTED_MODULE_0___default.a.func.isRequired,
  onPasswordChange: prop_types__WEBPACK_IMPORTED_MODULE_0___default.a.func.isRequired,
...
/*!********************************************************************************************!*\
  ...
  \********************************************************************************************/
/*! exports provided: CartDispatcher, MyAccountDispatcher, mapStateToProps, mapDispatchToProps, _CheckoutContainer, CheckoutContainer, default */
/***/ (function(module, __webpack_exports__, __webpack_require__) {
...
function (_Extensible) {
  ...
  _createClass(_CheckoutContainer, [{
    ...
    key: "componentDidUpdate",
    value: function componentDidUpdate(prevProps) {
      var urlStep = this.props.match.params.step;
      var prevUrlStep = prevProps.match.params.step; // Handle going back from billing to shipping
    ...
    value: function onShippingEstimationFieldsChange(address) {
      ...
      middleware(function (_ref4) {
        var shippingMethods = _ref4.estimateShippingCosts;
    ...
    value: function setDetailsStep(orderID) {
      var _this$props2 = this.props,
          resetCart = _this$props2.resetCart,
          setNavigationState = _this$props2.setNavigationState; // For some reason not logged in user cart preserves qty in it
    ...
    value: function _getPaymentMethods() {
      ...
      middleware(function (_ref5) {
        var paymentMethods = _ref5.getPaymentMethods;
    ...
    value: function saveGuestEmail() {
      ...
      middleware(function (_ref6) {
        var data = _ref6.setGuestEmailOnCart;
        return data;
    ...
    value: function () {
      ...
      _babel_runtime_regenerator__WEBPACK_IMPORTED_MODULE_0___default.a.mark(function _callee2() {
        var _this$props3, createAccount, is_virtual, showSuccessNotification, _this$state, email, password, isCreateUser, _this$state$shippingA, firstname, lastname, options, creation;

        return _babel_runtime_regenerator__WEBPACK_IMPORTED_MODULE_0___default.a.wrap(function _callee2$(_context2) {
          while (1) {
            switch (_context2.prev = _context2.next) {
              case 0:
                _this$props3 = this.props, createAccount = _this$props3.createAccount, is_virtual = _this$props3.totals.is_virtual, showSuccessNotification = _this$props3.showSuccessNotification;
            ...
            switch (_context3.prev = _context3.next) {
              ...
              case 8:
                ...
                middleware(function (_ref7) {
                  var data = _ref7.saveAddressInformation;
    ...
    value: function trimAddressMagentoStyle(address) {
      ...
      if (region_id) {
        ...
        var _ref8 = countries.find(function (_ref9) {
          var id = _ref9.id;
          return id === country_id;
        }) || {},
            available_regions = _ref8.available_regions;
        ...
        var _ref10 = available_regions.find(function (_ref11) {
          var id = _ref11.id;
          return +id === +region_id;
        }) || {},
            code = _ref10.code;
...
/*!***************************************************************************!*\
  ...
  \***************************************************************************/
/*! exports provided: formatCurrency, calculateFinalPrice, roundPrice */
/***/ (function(module, __webpack_exports__, __webpack_require__) {
